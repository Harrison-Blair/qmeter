...
func TestFetchBalances(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "synthetic live shape", fixture: "usage_ledger_synthetic.json", want: usd(ledgerNumber(0), ledgerNumber(1), ledgerNumber(1))},
		...
		{name: "percent fallback known zero", spend: `null`, extra: `{"is_enabled":false,"monthly_limit":100,"used_credits":0,"currency":"USD","decimal_places":2,"utilization":0}`, want: percent(0)},
